...
Dame::Dame(int x,int y,int coul,string id,Echiquier E):Piece::Piece(x,y,coul,id,E)
{
	pos_x=x;
	pos_y=y;
	m_id=id;
...
bool Dame::validation(int x_vise,int y_vise,Echiquier E)
{
	...
	for (iter=v.begin();iter!=v.end();++iter)
	{
		...
		if (10*x_vise+y_vise == *iter)
			{	cout<<"true"<<endl;						//Le mouvement est-il dans le vecteur des mouveements possibles?
				v.clear();
			return true;}
	}
	cout<<"false"<<endl;
...
void Dame::deplacement(int x_vise,int y_vise,Echiquier E)
{
