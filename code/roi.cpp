...
Roi::Roi(int x,int y,int coul,string id,Echiquier E):Piece::Piece(x,y,coul,id,E)
{
	pos_x=x;
	pos_y=y;
	m_id=id;
...
void Roi::deplacement(int x_vise,int y_vise,Echiquier E)
{
